...
urlpatterns = [
    ...
    path('campaignselection_json', dnd.campaignSelection_json, name='campaignSelection_json'),
    path('playerselection_json', dnd.playerSelection_json, name='playerSelection_json'),
    path('get_room_history', dnd.get_room_history, name='get_room_history'),
]
